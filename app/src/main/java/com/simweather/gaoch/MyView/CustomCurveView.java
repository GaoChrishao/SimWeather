...
public class CustomCurveView extends View {
    ...
    public CustomCurveView(Context context, String[] xLabel, String[] yLabel, List<int[]> dataList, List<Integer> colorList, boolean showValue) {
        super(context);
        this.xLabel = xLabel;
        this.yLabel = yLabel;
    ...
    public void init() {
        ...
        paintAxes.setColor(ContextCompat.getColor(getContext(), R.color.colorText));
        ...
        paintCoordinate.setColor(ContextCompat.getColor(getContext(), R.color.colorText));
        ...
        paintTable.setColor(ContextCompat.getColor(getContext(), R.color.colorText));
        ...
        paintValue.setColor(ContextCompat.getColor(getContext(), R.color.colorText));
    ...
    protected void onDraw(Canvas canvas) {
        canvas.drawColor(ContextCompat.getColor(getContext(), R.color.colorText));
        init();
